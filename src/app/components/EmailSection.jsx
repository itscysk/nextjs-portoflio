    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex-row gap-2 text-base">
          ...
          <h5 className="text-[2rem] font-bold my-2 relative top-[6rem] flex items-center justify-center w-12 h-12 text-white  from-primary-400 to-secondary-600 bg-gradient-to-r  rounded-full"><FaDiscord /></h5>
          <h5 className="text-[2rem] font-bold text-white my-2 relative top-[6rem] flex items-center justify-center w-12 h-12 bg-grays rounded-full from-primary-400 to-secondary-600 bg-gradient-to-r"><FaInstagram /></h5>
          <h5 className="text-[2rem] font-bold text-white my-2 relative top-[6rem] flex items-center justify-center w-12 h-12 bg-grays rounded-full from-primary-400 to-secondary-600 bg-gradient-to-r"><FaGithub /></h5>
          <h5 className="text-[2rem] font-bold text-white my-2 relative top-[6rem] flex items-center justify-center w-12 h-12 bg-grays rounded-full from-primary-400 to-secondary-600 bg-gradient-to-r"><FaInstagram /></h5>
          </div>
        </div>
